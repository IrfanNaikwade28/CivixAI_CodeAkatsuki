...
import {
  ...
  Calendar, User, Home, Images, Save,
...
// ── Helper: build 'YYYY-MM-DD' from parts (returns '' if incomplete) ────────
...
export default function CitizenProfile({ onLogout }) {
  ...
  // Editable profile fields — pre-fill from context
  ...
  const handleUpdateProfile = async () => {
    ...
    if (!ward.trim())       { setProfileError('Ward is required.'); return; }
      ...
      <View style={styles.root}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.profileRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.profileRole}>Citizen</Text>
          ...
          <View style={[styles.card, styles.cardFirst]}>
            ...
            <InfoRow Icon={Hash}  label="Citizen ID" value={user?.displayId} />
            <InfoRow Icon={Mail}  label="Email"      value={user?.email} />
            {/* Phone — locked, cannot be changed after registration */}
          ...
          <View style={styles.card}>
            ...
            {/* Ward */}
            <View style={styles.fieldGroup}>
              <Text style={styles.fieldLabel}>Ward <Text style={styles.required}>*</Text></Text>
              <View style={styles.inputRow}>
          ...
          <View style={styles.card}>
            ...
            {pwStep === 'idle' && (
              <>
                ...
                <View style={[styles.inputRow, { marginBottom: 14 }]}>
                  ...
                  />
                  <TouchableOpacity onPress={() => setShowCurrent(v => !v)} style={{ padding: 4 }}>
            ...
            {pwStep === 'success' && (
              <TouchableOpacity style={styles.otpTriggerBtn} onPress={() => setPwStep('idle')}>
...
const styles = StyleSheet.create({
  ...
  // Header
  header: { paddingTop: 52, paddingBottom: 64, paddingHorizontal: 20, backgroundColor: '#2563eb', overflow: 'hidden', position: 'relative' },
  decCircle1: { position: 'absolute', top: -24, right: -24, width: 128, height: 128, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 64 },
  decCircle2: { position: 'absolute', top: 40, right: 32, width: 56, height: 56, backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 28 },
  profileRow: { flexDirection: 'row', alignItems: 'center', gap: 16, zIndex: 1 },

  // Avatar
  avatarWrapper: { position: 'relative' },
  avatarBox: { width: 68, height: 68, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.25)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.4)' },
  avatarImage: { width: 68, height: 68, borderRadius: 20, borderWidth: 2, borderColor: 'rgba(255,255,255,0.4)' },
  avatarText: { color: '#fff', fontSize: 26, fontWeight: '700' },
  cameraBadge: { position: 'absolute', bottom: -4, right: -4, width: 24, height: 24, backgroundColor: '#1d4ed8', borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#fff' },

  profileName: { color: '#fff', fontSize: 20, fontWeight: '700' },
  profileRole: { color: '#bfdbfe', fontSize: 13, marginTop: 2 },
  profileBadges: { flexDirection: 'row', gap: 8, marginTop: 6 },
  wardBadge: { backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 20 },
  ...
  idBadgeText: { color: '#dbeafe', fontSize: 11, fontWeight: '500' },
  ...
  // Update profile button
  updateProfileBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#2563eb', borderRadius: 14, paddingVertical: 14 },
  ...
  updateBtn: { borderRadius: 12, paddingVertical: 13, alignItems: 'center', backgroundColor: '#2563eb', marginTop: 4 },
